...
/**
 * Client for the Line Sorter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/linesorter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/linesorter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LinesorterClient] {$message}\n";
        }
    }
}
