# Line Sorter API - Examples

This folder contains example code for using the Line Sorter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/linesorter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/linesorter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/linesorter](https://docs.apiverve.com/ref/linesorter)
