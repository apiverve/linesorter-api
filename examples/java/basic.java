...
public class BasicExample {
    public static void main(String[] args) {
        ...
        LineSorterAPIClient client = new LineSorterAPIClient("YOUR_API_KEY_HERE");

        try {
            // Request body
            Map&lt;String, Object&gt; parameters &#x3D; new HashMap&lt;&gt;();
        parameters.put(&quot;lines&quot;, The quick brown fox jumps over the lazy dog,An apple a day keeps the doctor away,banana,Cherry blossoms bloom in spring,date);
