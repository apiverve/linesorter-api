...
namespace APIVerve.API.LineSorter
{
    ...
    /// <summary>
    /// Client for the LineSorter API
    /// </summary>
    public class LineSorterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/linesorter";
        ...
        {
            { "lines", new ValidationRule { Type = "array", Required = true } },
            { "order", new ValidationRule { Type = "string", Required = false } },
            { "caseSensitive", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public LineSorterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LineSorterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LineSorterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, LineSorterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(LineSorterQueryOptions options)
        {
        ...
        public ResponseObj Execute(LineSorterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(LineSorterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(LineSorterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(LineSorterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(LineSorterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(LineSorterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(LineSorterQueryOptions options)
        {
