...
class linesorterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/linesorter');
        }
        ...
        this.validationRules = {"lines":{"type":"array","required":true},"order":{"type":"string","required":false,"default":"asc"},"caseSensitive":{"type":"boolean","required":false,"default":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/linesorter`);
        }
    }
...
module.exports = linesorterWrapper;
