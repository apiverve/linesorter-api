...
```gradle
dependencies {
    implementation 'com.github.apiverve:linesorter-api:1.1.12'
}
```
...
```java
import com.apiverve.linesorter.LineSorterAPIClient;
import com.apiverve.linesorter.APIResponse;
import com.apiverve.linesorter.APIException;

// Initialize the client
LineSorterAPIClient client = new LineSorterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/linesorter](https://docs.apiverve.com/ref/linesorter)
...
- **Documentation:** [https://docs.apiverve.com/ref/linesorter](https://docs.apiverve.com/ref/linesorter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/linesorter-api/issues)
