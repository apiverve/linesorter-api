// Package linesorter provides a Go client for the Line Sorter API.
//
// For more information, visit: https://apiverve.com/marketplace/linesorter?utm_source=go&utm_medium=readme
package linesorter
...
// Request contains the parameters for the Line Sorter API.
//
// Parameters:
//   - lines (required): array - Array of text lines to sort (max 10,000)
//   - order: string - Sort order
//   - caseSensitive: boolean - Enable case-sensitive sorting
type Request struct {
	Lines []string `json:"lines"` // Required
	Order string `json:"order,omitempty"` // Optional
	CaseSensitive bool `json:"caseSensitive,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Line Sorter API.
